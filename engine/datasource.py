import json, urllib.request, urllib.error, sqlite3, os, csv, re, time, sys
...
INDEX_PATH = os.path.join(_data_dir(), "stock_index.csv")
DB_PATH = os.path.join(_data_dir(), "stock_history.db")
